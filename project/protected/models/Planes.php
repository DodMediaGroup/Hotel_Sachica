 ...
 * @property ItemPlanes[] $itemPlanes
 */
class Planes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idplanes, titulo, descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'itemPlanes' => array(self::HAS_MANY, 'ItemPlanes', 'planes_idplanes'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idplanes',$this->idplanes);
