...
<html>
    <head>
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/js/admin/config.js"></script>
    ...
    <div class="md-modal md-just-me" id="logout-modal">
        <div class="md-content">
            ...
            <div>
                <p class="text-center">¿Seguro quieres salir del sistema de administracion de hotel Sachica?</p>
                <p class="text-center">
                <button class="btn btn-danger md-close">No!</button>
                <a href="<?php echo Yii::app()->createUrl('admin_hotel/logout') ?>" class="btn btn-success md-close">Si, quiero salir</a>
                </p>
            </div>
        </div>
    </div>        <!-- Modal End -->
    ...
    <div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <!-- Footer Start -->
                <footer>
                    DodMediaGroup &copy; 2016
                    <div class="footer-links pull-right">
                        <a href="http://dodmediagroup.co" target="_blank">About</a>
                        <a href="http://dodmediagroup.co/#contacto" target="_blank">Contact Us</a>
                    </div>
                </footer>
                <!-- Footer End -->         
            </div>
