...
<div class="topbar">
    <div class="topbar-left">
        <div class="logo">
            <h1><a href="<?php echo $this->createUrl('index/') ?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/logo-admin.png" alt="Logo"></a></h1>
        </div>
                ...
                <ul class="nav navbar-nav navbar-right top-navbar">
                    ...
                    <li class="dropdown topbar-profile">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li><a href="javascript:;" onclick="notify('warning')"><i class="icon-help-2"></i> Ayuda</a></li>
